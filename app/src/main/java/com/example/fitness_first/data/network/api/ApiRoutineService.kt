...
interface ApiRoutineService {
    ...
    @GET("routines")
    suspend fun getRoutinesWFilter(@Query("page") page: Int, @Query("orderBy") orderBy: String, @Query("direction") direction: String) : Response<NetworkPagedContent<NetworkRoutine>>
